...
%if 0%{?rel_build}
Source0: https://github.com/skycastlelily/%{srcname}/archive/%{version}.tar.gz#/%{gittar}
%else
Source0: https://github.com/skycastlelily/%{srcname}/archive/%{commit}.tar.gz#/%{gittar}
